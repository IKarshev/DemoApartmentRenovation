...
class AutoAddIblockElementPropertyYoutubeVideoIdToIb720240721095923438416 extends BitrixMigration
{
    /**
     * Run the migration.
     *
    ...
    public function up()
    {
        $fields = array (
  'ID' => 0,
  'NAME' => 'ID Youtube-видео',
  'SORT' => 500,
  'CODE' => 'YOUTUBE_VIDEO_ID',
  'MULTIPLE' => 'N',
  'IS_REQUIRED' => 'N',
  'ACTIVE' => 'Y',
  'USER_TYPE' => false,
  ...
  array (
    ...
    {
        $id = $this->getIblockPropIdByCode('YOUTUBE_VIDEO_ID', 7);
