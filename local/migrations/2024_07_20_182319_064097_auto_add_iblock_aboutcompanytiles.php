...
class AutoAddIblockAboutcompanytiles20240720182319064097 extends BitrixMigration
{
    /**
     * Run the migration.
     *
  ...
  'NAME' => 'Преимущества "О компании"',
  'CODE' => 'AboutCompanyTiles',
  'API_CODE' => 'AboutCompanyTiles',
  'LIST_PAGE_URL' => '',
  'DETAIL_PAGE_URL' => '',
  'CANONICAL_PAGE_URL' => '',
  'DESCRIPTION' => '',
  ...
  'VERSION' => '1',
    ...
    {
        $id = $this->getIblockIdByCode('AboutCompanyTiles');
